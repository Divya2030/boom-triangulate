...
loop did not blame BOOM. Instead it flagged an \cls{oracle\_mismatch}, because
Spike traps misaligned loads while Dromajo permits them---a real policy
difference between the two references, not a design bug. This is the
classification working on real input: the loop kept BOOM clear and pointed at the
right source of the difference.
